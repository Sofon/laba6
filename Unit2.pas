...
function PoiskOtr; //Ищем есть ли хотя бы один отрицательный элемент после последнего Т
var
  flag:Boolean;
  j,i:Byte;
begin
...
procedure PoiskMax; //Ищем максимальный последний отрицательный элемент=)
 var i,j:byte;
 flag:boolean;
begin
  amax:=a[iotr,jotr];
